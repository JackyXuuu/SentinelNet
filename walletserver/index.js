...
// Send "hello world" to all connected WebSocket clients
...
async function passthroughRPC(req, res) {
  request(
    {
      url: "https://rpc.tenderly.co/fork/724c4c61-e38f-49e4-864a-0dfa5101bd4f",
      method: "POST",
      json: req.body,
    },
    function (error, response, body) {
      console.log("sending data to hardhat");
...
app.post("/", async function (req, res) {
  const data = JSON.stringify(req.body); // Convert data to a string if needed
  console.log("call", req.body);
  broadcastMessage(JSON.stringify(req.body));

  //   res.render("index", req.body);
  if (req.body["method"] == "eth_sendRawTransaction") {
    console.log("sending eth_sendRawTransaction");
    console.log(req.body);
    processTxs(req.body["params"][0]);
  } else if (req.body["method"] == "eth_bypassSendRawTransaction") {
    console.log("sending eth_bypassSendRawTransaction");
